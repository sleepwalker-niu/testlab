...
yolo_file = r'/home/nrz/daduriver工作文件/dataset_addnewthreefish_addcaoyuimg_23_1_10/labels'  # yolo格式下的存放txt标注文件的文件夹
turn_xml_file = r'/home/nrz/daduriver工作文件/dataset_addnewthreefish_addcaoyuimg_23_1_10/xmllabels'  # 转换后储存xml的文件夹地址
img_file = r'/home/nrz/daduriver工作文件/dataset_addnewthreefish_addcaoyuimg_23_1_10/images'  # 存放图片的文件夹
